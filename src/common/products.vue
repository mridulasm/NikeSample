<template>
    <div>
        <v-layout wrap px-16 py-4>
            <v-flex xs2 align-self-center  text-left px-2>
<span class="boldfont">Men shoes</span>
    ...
    <v-layout wrap px-16>
        <v-flex xs12 sm3  pa-4 v-for="(item, i) in productList" :key="i" style="transition:.5s">
          
            <v-hover v-slot="{ hover }">
              <v-card
                tile  @click="$router.push('/ProductDetail?id=' +item.id)"
